...
<meta name="description" content="Lima eléctrica giratoria TROGÜI. Envío gratis a toda Colombia. Pago contra entrega.">
...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  .topstrip{
    background:var(--ink); color:var(--cream); font-size:13px; letter-spacing:.03em;
  ...
  .catalog-link{
    ...
    border-bottom:2px solid var(--clay); padding-bottom:2px; white-space:nowrap;
  }
  .wa-btn{
    display:flex; align-items:center; gap:8px; background:var(--sage); color:var(--white);
    padding:10px 16px; border-radius:100px; font-weight:700; font-size:14px; text-decoration:none; white-space:nowrap;
  }
  ...
  .eyebrow{
    display:inline-flex; align-items:center; gap:8px; background:var(--sage-light); color:var(--sage);
    padding:6px 14px; border-radius:100px; font-size:13px; font-weight:700; margin-bottom:16px;
  }
  .hero h1{font-size:42px; line-height:1.08; color:var(--ink);}
  ...
  .badge-ship{
    display:inline-block; background:var(--gold); color:var(--ink); font-weight:800; font-size:12px;
    padding:5px 10px; border-radius:6px; animation:pulseBadge 2.4s ease-in-out infinite;
  }
  @keyframes pulseBadge{0%,100%{transform:scale(1);}50%{transform:scale(1.06);}}

  .cta-primary{
    display:inline-flex; align-items:center; justify-content:center; gap:10px; background:var(--clay); color:var(--white);
    font-weight:800; font-size:17px; padding:18px 30px; border-radius:12px; border:none; cursor:pointer;
    width:100%; max-width:420px; box-shadow:0 10px 24px rgba(232,93,42,0.32); text-decoration:none;
  ...
  .float-tag{
    position:absolute; bottom:-14px; left:-14px; background:var(--white); border-radius:12px; padding:10px 16px;
    box-shadow:0 12px 24px rgba(0,0,0,0.12); font-size:13px; font-weight:700; color:var(--sage);
    display:flex; align-items:center; gap:8px;
  }
  .float-tag .dot{width:8px; height:8px; border-radius:50%; background:var(--sage); animation:blink 1.6s infinite;}
  @keyframes blink{0%,100%{opacity:1;}50%{opacity:.3;}}

  @media(max-width:860px){ .hero-grid{grid-template-columns:1fr; gap:26px;} .hero h1{font-size:30px;} }
  ...
  .section-title h2{font-size:30px; color:var(--ink);}
  .section-title p{color:#5c655e; margin-top:10px; font-size:16px;}

  .video-wrap{ max-width:520px; margin:0 auto; border-radius:20px; overflow:hidden; box-shadow:0 20px 50px rgba(31,42,36,0.18); background:#000; }
  .video-wrap video{width:100%; display:block;}

  .ba-grid{display:grid; grid-template-columns:1.1fr 0.9fr; gap:24px; align-items:center;}
  ...
  .feat-icon{
    width:44px; height:44px; border-radius:12px; background:var(--clay); display:flex; align-items:center;
    justify-content:center; margin-bottom:14px; color:var(--white); font-family:'Fraunces',serif; font-weight:700;
  }
  ...
  .ticker-wrap{
    max-width:440px; margin:0 auto 40px; background:var(--white); border:1px solid var(--line); border-radius:14px;
    padding:14px 18px; display:flex; align-items:center; gap:12px; box-shadow:0 8px 20px rgba(0,0,0,0.05);
  }
  ...
  .form-row input, .form-row select{
    width:100%; padding:13px 14px; border-radius:10px; border:1px solid var(--line); font-family:'Work Sans',sans-serif;
  ...
  .addr-opt{
    flex:1; text-align:center; padding:12px 8px; border-radius:10px; border:1px solid var(--line); font-size:13px;
    font-weight:700; cursor:pointer; background:var(--cream);
  }
  ...
  .totalbar{
    display:flex; justify-content:space-between; align-items:center; padding:16px 18px; background:var(--sage-light);
  ...
  .sticky-cta{
    position:fixed; bottom:0; left:0; right:0; z-index:60; background:var(--white); border-top:1px solid var(--line);
    padding:12px 16px; display:none; box-shadow:0 -8px 20px rgba(0,0,0,0.08);
  }
  .sticky-cta a{
    display:block; text-align:center; background:var(--clay); color:var(--white); font-weight:800; padding:14px;
    border-radius:10px; text-decoration:none; animation:shakeCTA 3.2s ease-in-out infinite;
  }
...
<header>
  <div class="headerbar wrap">
    <div class="logo"><img src="img/logo-trogui.jpeg" alt="TROGÜI"></div>
    <div class="header-links">
      <a class="catalog-link" href="https://troguistore.github.io/web/" target="_blank">Ver catálogo</a>
...
<section class="hero">
  <div class="wrap hero-grid">
    ...
    <div class="hero-media">
      <img src="img/uso-talon.jpeg" alt="Uso de la lima eléctrica TROGÜI en el talón">
...
<section>
  <div class="wrap">
    <div class="section-title">
      <span class="eyebrow">Míralo en acción</span>
      <h2>Así funciona la lima eléctrica TROGÜI</h2>
      <p>Un giro suave que pule la piel dura sin esfuerzo.</p>
    </div>
    <div class="video-wrap">
      <video controls playsinline poster="img/uso-talon.jpeg">
        <source src="img/video-demo.mov" type="video/quicktime">
...
<section id="antes-despues">
  <div class="wrap">
    ...
    <div class="ba-grid">
      <div class="ba-card">
        <img src="img/antes-despues.jpeg" alt="Antes y después de usar la lima eléctrica TROGÜI en el talón">
        <div class="ba-cap">Antes y después: piel del talón renovada en un solo uso.</div>
      </div>
      <div class="ba-card">
        <img src="img/antes-collage.jpeg" alt="Piel dura y agrietada antes de usar TROGÜI">
        <div class="ba-cap">Así se ve la piel dura y agrietada que TROGÜI elimina.</div>
      </div>
    </div>
  </div>
</section>
...
<section class="feat-section">
  <div class="wrap">
    ...
    <div class="feat-grid">
      <div class="feat-card"><div class="feat-icon">360°</div><h3>Rodillo giratorio microabrasivo</h3><p>Elimina piel muerta y asperezas suavemente, sin raspar ni lastimar.</p></div>
      <div class="feat-card"><div class="feat-icon">⚡</div><h3>2 velocidades</h3><p>Modo suave para uso diario y modo potente para callos difíciles.</p></div>
      <div class="feat-card"><div class="feat-icon">💡</div><h3>Luz LED integrada</h3><p>Ilumina la zona de trabajo para mayor precisión, incluso de noche.</p></div>
      <div class="feat-card"><div class="feat-icon">🔋</div><h3>Inalámbrica y recargable</h3><p>Carga USB práctica, cuerpo resistente al agua y fácil de limpiar.</p></div>
      <div class="feat-card"><div class="feat-icon">✋</div><h3>Diseño ergonómico</h3><p>Se adapta a tu mano para llegar a talones, dedos y planta del pie.</p></div>
      <div class="feat-card"><div class="feat-icon">🔄</div><h3>2 rodillos incluidos</h3><p>Rodillo fino para pulido diario, rodillo grueso para callos persistentes.</p></div>
    </div>
  </div>
</section>
...
<section>
  <div class="wrap includes">
    <div class="kit-grid">
      <img src="img/producto-cabezales.jpeg" alt="Lima eléctrica TROGÜI con cabezales">
      <img src="img/empaque-caja.jpeg" alt="Empaque de la lima eléctrica TROGÜI">
      <img src="img/empaque-caja2.png" alt="Caja del kit de pedicura TROGÜI">
      <img src="img/blister-mano.jpeg" alt="Kit TROGÜI en mano">
    </div>
    <div>
...
<section class="trust">
  <div class="wrap">
    ...
    <div class="trust-img"><img src="img/transportadoras.jpeg" alt="Envíos con Interrapidísimo y Coordinadora"></div>
    ...
    <div class="order">
      <div class="order-grid">
        ...
        <div class="order-side">
          ...
          <img src="img/producto-cabezales.jpeg" alt="Contenido del kit TROGÜI" style="border-radius:16px;">
        </div>
      </div>
    </div>
  </div>
...
<footer>
  <div class="wrap foot-grid">
    <div class="foot-logo"><img src="img/logo-trogui.jpeg" alt="TROGÜI"></div>
...
<script>
  ...
  // Ticker de actividad: mensajes agregados y honestos (no inventamos compradores ni pedidos falsos).
  const tickerMessages = [
    "🚚 Hoy estamos despachando pedidos a Bogotá, Cali y Medellín",
    "✅ Cientos de pares de pies renovados con TROGÜI",
