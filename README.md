...
<body>
    ...
    <div class="container">
        ...
        <div class="form-popup" id="buyForm">
            ...
            <button onclick="sendWhatsApp()">Realizar compra por WhatsApp</button>
        </div>
    ...
    <script>
        ...
        function sendWhatsApp() {
            ...
            const whatsappMessage = `¡Hola! Quiero realizar una compra con los siguientes datos:\n` +
                                    `Nombre: ${nombre}\n` +
                                    `Apellido: ${apellido}\n` +
                                    `Contacto: ${contacto}\n` +
                                    `Dirección: ${direccion}\n` +
            ...
            const whatsappUrl = `https://wa.me/573206572598?text=${encodeURIComponent(whatsappMessage)}`;
